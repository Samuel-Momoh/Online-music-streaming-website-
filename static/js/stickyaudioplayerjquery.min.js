...
if ('mediaSession' in navigator) {
	navigator.mediaSession.metadata = new MediaMetadata({
	  ...
	  album: genre,
	  artwork: [
		{ src: 'http://127.0.0.1:5000/'+image,   sizes: '96x96',   type: 'image/png' },
		{ src: 'http://127.0.0.1:5000/'+image, sizes: '128x128', type: 'image/png' },
		{ src: 'http://127.0.0.1:5000/'+image, sizes: '192x192', type: 'image/png' },
		{ src: 'http://127.0.0.1:5000/'+image, sizes: '256x256', type: 'image/png' },
		{ src: 'http://127.0.0.1:5000/'+image, sizes: '384x384', type: 'image/png' },
		{ src: 'http://127.0.0.1:5000/'+image, sizes: '512x512', type: 'image/png' },
	  ]
	});
